...
class SaleControllerTest {
  ...
  void getSaleByIdReturnsSale() throws Exception {
    ...
    SaleResponse created =
        createSale(
            token,
            new SaleRequest(
                book.getId(), 2, 2024, 10, new BigDecimal("50.00"), false));
  ...
  void updateSaleUpdatesFields() throws Exception {
    ...
    SaleRequest update =
        new SaleRequest(
            book.getId(), 3, 2024, 25, new BigDecimal("200.00"), true);
  ...
  void getAllSalesShowAllReturnsAllRecords() throws Exception {
    ...
    for (int i = 1; i <= 30; i++) {
      createSale(
          token,
          new SaleRequest(
              book.getId(), 1, 2024, i, new BigDecimal("10.00"), false));
    }
  ...
  void getAllSalesFiltersByDateRange() throws Exception {
    ...
    createSale(
        token, new SaleRequest(book.getId(), 1, 2024, 5, new BigDecimal("10.00"), false));
    createSale(
        token, new SaleRequest(book.getId(), 3, 2024, 5, new BigDecimal("10.00"), false));
    createSale(
        token, new SaleRequest(book.getId(), 5, 2024, 5, new BigDecimal("10.00"), false));
