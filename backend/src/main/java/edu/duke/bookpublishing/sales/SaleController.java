...
public class SaleController {
  ...
  @Operation(operationId = "getRoyaltyReport",
      summary = "Generates an author royalty report for a quarter range")
  @GetMapping("/royalty-report")
  public RoyaltyReportResponse getRoyaltyReport(@RequestParam Long authorId,
      @RequestParam int startQuarter, @RequestParam int startYear, @RequestParam int endQuarter,
      @RequestParam int endYear,
      @RequestParam(defaultValue = "false") boolean includeEmptyQuarters) {
    return saleService.generateRoyaltyReport(authorId, startQuarter, startYear, endQuarter, endYear,
