...
public record SaleResponse(@Schema(description = "Unique sale identifier id") Long id,
        ...
        @Schema(description = "Indicates whether the author has been paid or not") boolean hasAuthorBeenPaid) {
