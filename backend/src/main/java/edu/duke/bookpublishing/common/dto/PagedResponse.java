...
/**
 * Generic Paged Response type. Allows for returns of custom paginated objects, such as Sale, Book,
 * etc. Gives the option to paginate or unpaginated and allows for mapping input.
 *
